...
urlpatterns = [
    ...
    path("locations/<slug:slug>/manage/table-stats/", location_views.LocationManageTableStatsView.as_view(),
         name="location-manage-table-stats"),
    ...
    path("events/<slug:slug>/save-phone/", event_views.EventSavePhoneView.as_view(), name="event-save-phone"),
    ...
    path("events/<slug:slug>/manage/categories/", event_views.EventManageCategoriesView.as_view(), name="event-manage-categories"),
    path("events/<slug:slug>/manage/categories/reorder/", event_views.EventManageCategoriesReorderView.as_view(), name="event-manage-categories-reorder"),
    path("events/<slug:slug>/manage/categories/<int:pk>/delete/", event_views.EventManageCategoryDeleteView.as_view(), name="event-manage-category-delete"),
    path("events/<slug:slug>/manage/stations/", event_views.EventManagePhysicalTablesView.as_view(), name="event-manage-stations"),
    path("events/<slug:slug>/manage/stations/reorder/", event_views.EventManagePhysicalTablesReorderView.as_view(), name="event-manage-stations-reorder"),
    path("events/<slug:slug>/manage/stations/<int:pk>/delete/", event_views.EventManagePhysicalTableDeleteView.as_view(), name="event-manage-station-delete"),
    ...
    path("events/<slug:slug>/manage/table-creators/", event_views.EventManageTableCreatorsView.as_view(), name="event-manage-table-creators"),
    path("events/<slug:slug>/manage/table-creators/<int:pk>/remove/", event_views.EventManageTableCreatorRemoveView.as_view(), name="event-manage-table-creator-remove"),
    ...
    path("account/connect/telegram/", profile_views.connect_telegram_page, name='connect-telegram'),
    path("account/disconnect/<str:provider>/", profile_views.disconnect_social, name='disconnect-social'),
